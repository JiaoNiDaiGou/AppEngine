...
import jiaoni.daigou.lib.teddy.TeddyClientImplOld;
...
public class VerifyTeddyClient {
    ...
    private static void makeOrderOld() {
        TeddyClient client = new TeddyClientImplOld(TeddyAdmins.HACK, new MockBrowserClient("test"));
        Receiver receiver = Receiver.builder()
                .withName("王小毛")
                .withPhone("12345678901")
                .withAddress("东方路3号")
