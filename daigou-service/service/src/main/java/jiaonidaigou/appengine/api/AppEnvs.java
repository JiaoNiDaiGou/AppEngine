...
public class AppEnvs extends Envs {
    ...
    private static final Map<Env, String> GAE_HOSTNAMES_BY_ENV;
    private static final String GCS_ROOT = "gs://daigou/";

    static {
        ENV = determineEnv();
        GAE_HOSTNAMES_BY_ENV = ImmutableMap.of(
    ...
    public static String getGaeHostname(final Env env) {
        checkNotNull(env);
        return GAE_HOSTNAMES_BY_ENV.get(env);
    }
