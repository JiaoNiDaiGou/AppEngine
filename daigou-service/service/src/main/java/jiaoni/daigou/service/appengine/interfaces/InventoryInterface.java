...
public class InventoryInterface {
    ...
    public InventoryInterface(final InventoryDbClient inventoryDbClient,
                              final ProductDbClient productDbClient) {
        this.inventoryDbClient = inventoryDbClient;
        this.productDbClient = productDbClient;
    }
    ...
    public Response getAll() {
        ...
        Map<String, Product> products = productDbClient.scan().collect(Collectors.toMap(Product::getId, t -> t));
    ...
    public Response createWithProduct(final InventoryItem inventoryItem) {
        ...
        Product product = productDbClient.put(inventoryItem.getProduct());
    ...
    public Response updateProduct(@QueryParam("productId") final String productId,
        ...
        Product product = productDbClient.getById(productId);
        if (product == null) {
