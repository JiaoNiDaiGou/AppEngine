 ...
 * <p>
 * NOTE:
 * It is only suitable for immutable data (or data rarely change).
 * Otherwise, it is problematic, as the local cache will be out sync.
 * <p>
 * TODO: impl a memcache client.
 *
 * @param <T> Entity type.
 */
